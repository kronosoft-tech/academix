...
import { SubscriptionBanner } from "../../shared/ui/components/SubscriptionBanner";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        <aside className="w-64 bg-background border-r border-foreground/20 fixed inset-y-0 left-0">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-foreground/20">
            <div className="relative">
              <button
                onClick={() => setShowUserMenu(!showUserMenu)}
                className="w-full flex items-center gap-3 hover:bg-secondary/10 rounded-lg p-2 transition-colors"
              >
              ...
              {showUserMenu && (
                <div className="absolute bottom-full left-0 right-0 mb-2 bg-background border border-foreground/20 rounded-lg shadow-lg overflow-hidden">
                  <button
                    onClick={() => {
                      setCurrentPage("profile");
                      setShowUserMenu(false);
                    }}
                    className="w-full flex items-center gap-3 px-4 py-3 text-sm text-foreground hover:bg-secondary/10 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-3 text-sm text-red-600 hover:bg-red-50 transition-colors border-t border-foreground/20"
                  >
                    <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
