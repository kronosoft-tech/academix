...
const EXPENSE_CATEGORIES = [
  { value: EXPENSE_CATEGORY.RENT, label: "Arriendo" },
  { value: EXPENSE_CATEGORY.SALARIES, label: "Sueldos" },
  { value: EXPENSE_CATEGORY.UTILITIES, label: "Servicios" },
  { value: EXPENSE_CATEGORY.OTHER, label: "Otros" },
] as const;

export function ExpenseForm({ onSubmit, onCancel, className }: ExpenseFormProps) {
  ...
  return (
    ...
    >
      <div className="mb-4">
        <h3 className="text-lg font-semibold text-[var(--color-foreground)]">Nuevo Gasto</h3>
      </div>
