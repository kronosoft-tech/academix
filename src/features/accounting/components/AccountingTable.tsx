...
export function EntriesTable({ entries, onRowClick, className }: EntriesTableProps) {
  return (
    <div className={cn("w-full overflow-hidden rounded-lg border border-slate-200", className)}>
      <table className="w-full">
        <thead className="bg-slate-50">
          <tr>
            <th className="h-10 px-4 text-left text-xs font-medium uppercase tracking-wide text-slate-500">
              Fecha
            </th>
            <th className="h-10 px-4 text-left text-xs font-medium uppercase tracking-wide text-slate-500">
              Referencia
            ...
            <th className="h-10 px-4 text-right text-xs font-medium uppercase tracking-wide text-slate-500">
              Monto
            </th>
            <th className="h-10 px-4 text-center text-xs font-medium uppercase tracking-wide text-slate-500">
              Tipo
            </th>
          </tr>
        </thead>
              ...
              <td className="whitespace-nowrap px-4 py-3 text-center">
                <span
                  className={cn(
                    ...
                    entry.entry_type === "manual" && "bg-blue-100 text-blue-700",
    ...
    <div className={cn("w-full overflow-hidden rounded-lg border border-slate-200", className)}>
      <table className="w-full">
        ...
        <tbody className="divide-y divide-slate-100">
          ...
          {employees.length === 0 && (
            <tr>
              <td colSpan={onEdit ? 9 : 8} className="px-4 py-8 text-center text-slate-500">
                No hay empleados
              </td>
            </tr>
          )}
